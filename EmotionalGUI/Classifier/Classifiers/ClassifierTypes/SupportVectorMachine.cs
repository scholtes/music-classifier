...
namespace Classifier
{
    public class SupportVectorMachine : BaseClassifierType, IClassifierType
    {
        ...
        /// <summary>
        /// Load the classifier from files. These files should be generated by the SaveClassifier function.
        /// </summary>
        ...
        /// <summary>
        /// Save the classifiers to file. Should only be called after training the classifiers.
        /// </summary>
        /// <param name="positivityPath">Path to positivity SVM.</param>
        /// <param name="energyPath">Path to energy SVM.</param>
